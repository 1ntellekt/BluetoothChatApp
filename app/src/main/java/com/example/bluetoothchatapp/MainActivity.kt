...
import com.example.bluetoothchatapp.Sockets.BClientSocket
import com.example.bluetoothchatapp.Sockets.BServerSocket
import com.example.bluetoothchatapp.Util.BluetoothStateCustom
import com.example.bluetoothchatapp.Util.FileTransfer
import com.example.bluetoothchatapp.Util.MyLocationListener
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            listView.onItemClickListener = AdapterView.OnItemClickListener { parent, view, position, id ->
                ...
                val bClientSocket = BClientSocket(bluetoothDevices[position],uuid,object:OnHandlerMsg{
                    override fun onMsgGet(msg: Message) {
                        handler.sendMessage(msg)
                    }
                }, object:OnSocketReceive{
